...
<body onload="getJSON()">
    ...
    <div class="container-fluid body-content">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <p>This page shows data regarding flight information of selected flights flying in and out of Glasgow Airport.</p>
                <p>The map shows the airports and the current flights represented as a small
                    aeroplane.</p>
                <p>The chart can be zoomed in using your mouse and the data within the chart is
                    clickable.</p>
                <p>Clicking the <img src="img/plane.png" ; title="Plane Icon"> on the map displays the flight information of the selection.<br>Clicking
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDJFdzFzjYX5JD0d-xcz5q7s68LZEH3X90&callback=initMap">
    </script>
    <!-- end gmaps-->
    <script>
